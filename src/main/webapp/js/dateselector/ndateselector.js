    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string')
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div  name="temp_dates" class="ranges" style="height:300px;overflow:scroll" />' +
                '<div class="ranges">' +
    ...
    DateRangePicker.prototype = {
            ...
            if (this.endDate) {
                ...
                if(this.mulitDates && this.click_temp){
		            ...
		            for(i=0;i<this.temp_dates.length;i++){
		            	if(tempName == this.temp_dates[i].display){
		            		checkNames = true;
		            	}
		            }
		            if(!checkNames){
		            	this.temp_dates[this.temp_dates.length] = {start:this.startDate.format(this.locale.format),end:this.endDate.format(this.locale.format),display:tempName};
		            }
		            var tname = "";
		            for(i=0;i<this.temp_dates.length;i++){
		            	var r = Math.random();
		            	tname+= "<p><span id='t_"+r+"' title='"+this.temp_dates[i].display+"'>"+this.temp_dates[i].display + "<button class='temp_dates_span'>x</button></span></p>";
		            }
		            $('div[name="temp_dates"]')[$('div[name="temp_dates"]').length-1].innerHTML =  '<span>选择结果</span>'+ tname;
        ...
        deleteT:function(e){
        	...
        	for (var i = 0; i < this.temp_dates.length; i++) {  
			        if (this.temp_dates[i].display == e.target.parentNode.title) {
			        	index =  i;
			            break;  
			        }
			    }  
        ...
        show: function(e) {
        	this.temp_dates = [];
        	$('div[name="temp_dates"]')[$('div[name="temp_dates"]').length-1].innerHTML =""
...
//            if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate))//时间如果和上次选择相同不返回
    ...
    $.fn.daterangepicker = function(options, callback) {
        this.each(function() {
            ...
            //wei.li modify
           $('div[name="temp_dates"]')[$('div[name="temp_dates"]').length-1].style.display="block";
            $('div[name="temp_dates"]')[$('div[name="temp_dates"]').length-1].style.width="160px";
        });
        return this;
    };
